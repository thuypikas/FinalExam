...
<body>
	...
	<hr />
	<h3>Update</h3>
	<form:form action="update" method="post" modelAttribute="khambenh">
		<input type="hidden" name="makb" value="${khambenh.makb }">
		<!-- thêm cái này để truyền makb -->
		<table>
			<tr>
				<td>Tên bệnh nhân</td>
			...
			<tr>
				...
				<td><form:select path="bacSi.mabs">
						<form:options items="${bacSis}" itemValue="mabs" itemLabel="tenbs"></form:options>
					</form:select></td>
			</tr>
		</table>
		<button>Save</button>
